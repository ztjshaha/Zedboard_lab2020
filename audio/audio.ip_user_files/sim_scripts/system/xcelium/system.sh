...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../audio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../audio.srcs/sources_1/bd/system/ipshared/5bb9/hdl/verilog" \
       +incdir+"$ref_dir/../../../../audio.srcs/sources_1/bd/system/ipshared/70fd/hdl" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/5bb9/hdl/verilog" \
       +incdir+"../../../../audio.srcs/sources_1/bd/system/ipshared/70fd/hdl" \
       +incdir+"C:/software/program_software/Xilinx/Vivado/2018.2/data/xilinx_vip/include"
}
