...
static void prvledswTask( void *pvParameters );
static void prvprintfTask( void *pvParameters );
...
int main( void )
{
	...
	xTaskCreate( 	prvledswTask, 					/* The function that implements the task. */
					( const char * ) "LED_SW", 		/* Text name for the task, provided to assist debugging only. */
					configMINIMAL_STACK_SIZE, 	/* The stack allocated to the task. */
					NULL, 						/* The task parameter is not used, so set to NULL. */
					tskIDLE_PRIORITY,			/* The task runs at the idle priority. */
					&xTxTask );

	xTaskCreate( prvprintfTask,
				 ( const char * ) "PRINTF",
